...
const TvDetails = () => {
  ...
  return info ? (
    <div
      className="w-screen  h-[220vh] px-[10%]"
      style={{
    ...
    >
      ...
      {info.watchproviders && info.watchproviders.flatrate && (
        ...
        {info.watchproviders && info.watchproviders.flatrate && (
          <div className="flex items-center gap-x-7 text-white ">
            ...
            {info.watchproviders.rent  && info.watchproviders.rent.map((w,i) => (
              <img
                key={i}
                title={w.provider_name}
                className="w-[5vh] h-[5vh] object-cover rounded-md"
        ...
        {info.watchproviders && info.watchproviders.flatrate && (
          <div className="flex items-center gap-x-7 text-white ">
            ...
            {info.watchproviders.buy  && info.watchproviders.buy.map((w,i) => (
              <img
                key={i}
                title={w.provider_name}
                className="w-[5vh] h-[5vh] object-cover rounded-md"
      ...
      <HorizontalCards
        data={
          info.recommendations && info.recommendations.length > 0 ? info.recommendations : info.similar
        }
      />
      <Outlet />
    </div>
